...
| Skill | Description |
|-------|-------------|
| [gaoshanwen-methodology](./gaoshanwen-methodology/) | 高善文·宏观分析思维方法论 v5.5 — 三层架构（能力层/操作层/表达层），D_fetch 数据中间层（23指标/三源合一），GAOBO 两遍制 + Loop 逐轮收敛（至多 3 轮），三种输出模式（演讲/研报/评论），强制 md 报告落盘 |
