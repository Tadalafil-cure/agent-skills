...
| `gpt-image-2` | GPT Image 2 | 2-32积分（按分辨率和张数计算） |
...
| quality | 否 | GPT Image 2 质量：auto / low / medium / high |
| count | 否 | GPT Image 2 生成张数：1-4 |
...
| generate_audio | 否 | 即梦视频自动添加声音/音画同步，支持的模型开启后会增加积分消耗 |
